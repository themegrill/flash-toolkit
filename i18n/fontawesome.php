...
return array(
	...
	'fa-address-book'                        => __( 'Address Book', 'flash-toolkit' ),
	'fa-address-book-o'                      => __( 'Address Book O', 'flash-toolkit' ),
	'fa-address-card'                        => __( 'Address Card', 'flash-toolkit' ),
	'fa-address-card-o'                      => __( 'Address Card O', 'flash-toolkit' ),
	...
	'fa-american-sign-language-interpreting' => __( 'American Sign Language Interpreting', 'flash-toolkit' ),
	...
	'fa-arrows-h'                            => __( 'Arrows H', 'flash-toolkit' ),
	'fa-arrows-v'                            => __( 'Arrows V', 'flash-toolkit' ),
	...
	'fa-bandcamp'                            => __( 'Bandcamp', 'flash-toolkit' ),
	...
	'fa-bath'                                => __( 'Bath', 'flash-toolkit' ),
	'fa-bathtub'                             => __( 'Bathtub', 'flash-toolkit' ),
	'fa-battery'                             => __( 'Battery', 'flash-toolkit' ),
	...
	'fa-battery-three-quarters'              => __( 'Battery Three Quarters', 'flash-toolkit' ),
	...
	'fa-bookmark-o'                          => __( 'Bookmark O', 'flash-toolkit' ),
	...
	'fa-calendar-check-o'                    => __( 'Calendar Check O', 'flash-toolkit' ),
	'fa-calendar-minus-o'                    => __( 'Calendar Minus O', 'flash-toolkit' ),
	'fa-calendar-o'                          => __( 'Calendar O', 'flash-toolkit' ),
	'fa-calendar-plus-o'                     => __( 'Calendar Plus O', 'flash-toolkit' ),
	'fa-calendar-times-o'                    => __( 'Calendar Times O', 'flash-toolkit' ),
	...
	'fa-chain'                               => __( 'Chain', 'flash-toolkit' ),
	...
	'fa-circle-o-notch'                      => __( 'Circle O Notch', 'flash-toolkit' ),
	...
	'fa-deafness'                            => __( 'Deafness', 'flash-toolkit' ),
	...
	'fa-dollar'                              => __( 'Dollar', 'flash-toolkit' ),
	'fa-dot-circle-o'                        => __( 'Dot Circle O', 'flash-toolkit' ),
	'fa-download'                            => __( 'Download', 'flash-toolkit' ),
	'fa-dribbble'                            => __( 'Dribbble', 'flash-toolkit' ),
	'fa-drivers-license'                     => __( 'Drivers License', 'flash-toolkit' ),
	'fa-drivers-license-o'                   => __( 'Drivers License O', 'flash-toolkit' ),
	...
	'fa-eercast'                             => __( 'Eercast', 'flash-toolkit' ),
	...
	'fa-envelope-open'                       => __( 'Envelope Open', 'flash-toolkit' ),
	'fa-envelope-open-o'                     => __( 'Envelope Open O', 'flash-toolkit' ),
	'fa-envelope-square'                     => __( 'Envelope Square', 'flash-toolkit' ),
	'fa-envira'                              => __( 'Envira', 'flash-toolkit' ),
	'fa-eraser'                              => __( 'Eraser', 'flash-toolkit' ),
	'fa-etsy'                                => __( 'Etsy', 'flash-toolkit' ),
	'fa-eur'                                 => __( 'Eur', 'flash-toolkit' ),
	...
	'fa-free-code-camp'                      => __( 'Free Code Camp', 'flash-toolkit' ),
	...
	'fa-handshake-o'                         => __( 'Handshake O', 'flash-toolkit' ),
	...
	'fa-id-badge'                            => __( 'Id Badge', 'flash-toolkit' ),
	'fa-id-card'                             => __( 'Id Card', 'flash-toolkit' ),
	'fa-id-card-o'                           => __( 'Id Card O', 'flash-toolkit' ),
	'fa-ils'                                 => __( 'Ils', 'flash-toolkit' ),
	'fa-image'                               => __( 'Image', 'flash-toolkit' ),
	'fa-imdb'                                => __( 'Imdb', 'flash-toolkit' ),
	...
	'fa-linode'                              => __( 'Linode', 'flash-toolkit' ),
	...
	'fa-meetup'                              => __( 'Meetup', 'flash-toolkit' ),
	'fa-meh-o'                               => __( 'Meh O', 'flash-toolkit' ),
	'fa-mercury'                             => __( 'Mercury', 'flash-toolkit' ),
	'fa-microchip'                           => __( 'Microchip', 'flash-toolkit' ),
	...
	'fa-mobile-phone'                        => __( 'Mobile Phone', 'flash-toolkit' ),
	'fa-modx'                                => __( 'Modx', 'flash-toolkit' ),
	...
	'fa-optin-monster'                       => __( 'Optin Monster', 'flash-toolkit' ),
	...
	'fa-pause'                               => __( 'Pause', 'flash-toolkit' ),
	'fa-pause-circle'                        => __( 'Pause Circle', 'flash-toolkit' ),
	'fa-pause-circle-o'                      => __( 'Pause Circle O', 'flash-toolkit' ),
	'fa-paw'                                 => __( 'Paw', 'flash-toolkit' ),
	'fa-paypal'                              => __( 'Paypal', 'flash-toolkit' ),
	'fa-pencil'                              => __( 'Pencil', 'flash-toolkit' ),
	'fa-pencil-square'                       => __( 'Pencil Square', 'flash-toolkit' ),
	...
	'fa-podcast'                             => __( 'Podcast', 'flash-toolkit' ),
	'fa-power-off'                           => __( 'Power Off', 'flash-toolkit' ),
	'fa-print'                               => __( 'Print', 'flash-toolkit' ),
	'fa-product-hunt'                        => __( 'Product Hunt', 'flash-toolkit' ),
	...
	'fa-question-circle'                     => __( 'Question Circle', 'flash-toolkit' ),
	'fa-question-circle-o'                   => __( 'Question Circle O', 'flash-toolkit' ),
	'fa-quora'                               => __( 'Quora', 'flash-toolkit' ),
	...
	'fa-ravelry'                             => __( 'Ravelry', 'flash-toolkit' ),
	...
	'fa-resistance'                          => __( 'Resistance', 'flash-toolkit' ),
	...
	'fa-rub'                                 => __( 'Rub', 'flash-toolkit' ),
	'fa-ruble'                               => __( 'Ruble', 'flash-toolkit' ),
	'fa-rupee'                               => __( 'Rupee', 'flash-toolkit' ),
	'fa-s15'                                 => __( 'S15', 'flash-toolkit' ),
	...
	'fa-share-square'                        => __( 'Share Square', 'flash-toolkit' ),
	...
	'fa-shower'                              => __( 'Shower', 'flash-toolkit' ),
	'fa-sign-in'                             => __( 'Sign In', 'flash-toolkit' ),
	'fa-sign-language'                       => __( 'Sign Language', 'flash-toolkit' ),
	'fa-sign-out'                            => __( 'Sign Out', 'flash-toolkit' ),
	'fa-signal'                              => __( 'Signal', 'flash-toolkit' ),
	'fa-signing'                             => __( 'Signing', 'flash-toolkit' ),
	...
	'fa-snowflake-o'                         => __( 'Snowflake O', 'flash-toolkit' ),
	'fa-soccer-ball-o'                       => __( 'Soccer Ball O', 'flash-toolkit' ),
	...
	'fa-sort-amount-asc'                     => __( 'Sort Amount Asc', 'flash-toolkit' ),
	'fa-sort-amount-desc'                    => __( 'Sort Amount Desc', 'flash-toolkit' ),
	...
	'fa-star-half-full'                      => __( 'Star Half Full', 'flash-toolkit' ),
	'fa-star-half-o'                         => __( 'Star Half O', 'flash-toolkit' ),
	...
	'fa-sun-o'                               => __( 'Sun O', 'flash-toolkit' ),
	'fa-superpowers'                         => __( 'Superpowers', 'flash-toolkit' ),
	...
	'fa-telegram'                            => __( 'Telegram', 'flash-toolkit' ),
	...
	'fa-thermometer'                         => __( 'Thermometer', 'flash-toolkit' ),
	'fa-thermometer-0'                       => __( 'Thermometer 0', 'flash-toolkit' ),
	'fa-thermometer-1'                       => __( 'Thermometer 1', 'flash-toolkit' ),
	'fa-thermometer-2'                       => __( 'Thermometer 2', 'flash-toolkit' ),
	'fa-thermometer-3'                       => __( 'Thermometer 3', 'flash-toolkit' ),
	'fa-thermometer-4'                       => __( 'Thermometer 4', 'flash-toolkit' ),
	'fa-thermometer-empty'                   => __( 'Thermometer Empty', 'flash-toolkit' ),
	'fa-thermometer-full'                    => __( 'Thermometer Full', 'flash-toolkit' ),
	'fa-thermometer-half'                    => __( 'Thermometer Half', 'flash-toolkit' ),
	'fa-thermometer-quarter'                 => __( 'Thermometer Quarter', 'flash-toolkit' ),
	'fa-thermometer-three-quarters'          => __( 'Thermometer Three Quarters', 'flash-toolkit' ),
	...
	'fa-times-rectangle'                     => __( 'Times Rectangle', 'flash-toolkit' ),
	'fa-times-rectangle-o'                   => __( 'Times Rectangle O', 'flash-toolkit' ),
	...
	'fa-user-circle'                         => __( 'User Circle', 'flash-toolkit' ),
	'fa-user-circle-o'                       => __( 'User Circle O', 'flash-toolkit' ),
	'fa-user-md'                             => __( 'User Md', 'flash-toolkit' ),
	'fa-user-o'                              => __( 'User O', 'flash-toolkit' ),
	...
	'fa-vcard'                               => __( 'Vcard', 'flash-toolkit' ),
	'fa-vcard-o'                             => __( 'Vcard O', 'flash-toolkit' ),
	...
	'fa-window-close'                        => __( 'Window Close', 'flash-toolkit' ),
	'fa-window-close-o'                      => __( 'Window Close O', 'flash-toolkit' ),
	'fa-window-maximize'                     => __( 'Window Maximize', 'flash-toolkit' ),
	'fa-window-minimize'                     => __( 'Window Minimize', 'flash-toolkit' ),
	'fa-window-restore'                      => __( 'Window Restore', 'flash-toolkit' ),
	...
	'fa-wpexplorer'                          => __( 'Wpexplorer', 'flash-toolkit' ),
